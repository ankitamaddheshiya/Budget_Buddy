    ...
    data.forEach((element) => {
      ...
      down_arrow.addEventListener("click", () => {
        ...
        income_edit.addEventListener(
          ...
          async () => {
            let obj = {}
            await fetch(`https://periwinkle-catfish-cuff.cyclic.app/income/editincome/${element._id}`,{
              method: "PATCH",
              headers: {
                "Content-type": "application/json",
                authorization: `Bearer ${token}`
        ...
        income_delete.addEventListener(
          "click",
          async (data) => {
            await fetch(`https://periwinkle-catfish-cuff.cyclic.app/income/delete/${element._id}`,{
              method: "DELETE",
              headers: {
                "Content-type": "application/json",
                authorization: `Bearer ${token}`
